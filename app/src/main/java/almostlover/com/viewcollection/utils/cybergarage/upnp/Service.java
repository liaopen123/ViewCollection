...
import almostlover.com.viewcollection.utils.cybergarage.upnp.event.SubscriberList;
...
import almostlover.com.viewcollection.utils.cybergarage.upnp.xml.ServiceData;
...
import almostlover.com.viewcollection.utils.cybergarage.util.StringUtil;
...
public class Service
{
	...
	private Node getSCPDNode()
	{
		...
		try {
			String absoluteURL = rootDev.getAbsoluteURL(scpdURLStr);
			URL scpdUrl = new URL(absoluteURL);
