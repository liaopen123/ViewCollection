package almostlover.com.viewcollection.views.sixway2dragview.drag7viewdraghelper;
 ...
 */
public class Drag7FloatingDraggerViewGroup implements Observer {
    PositionObservable observable = PositionObservable.getInstance();
    FloatingDraggedView floatingDraggedView;

    public Drag7FloatingDraggerViewGroup(Context context, @LayoutRes int layoutResID) {
        // 用户布局
    ...
    public class FloatingDraggedView extends FrameLayout {
        ...
        protected void onDetachedFromWindow() {
            ...
            savePosition();
            observable.deleteObserver(Drag7FloatingDraggerViewGroup.this);
        }
